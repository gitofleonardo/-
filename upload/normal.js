...
function showLoadingDialog(){
    var bankLoad=document.getElementById("uploading-dialog")
    bankLoad.style.display="block"
}
...
function onAddContract(event){
    ...
    var input=document.getElementById("contact-input-container")
    input.reset()
}
function onAddInsChanged(event){
    ...
    imgContainer.appendChild(close)
    container.appendChild(imgContainer)
    var input=document.getElementById("ins-input-container")
    input.reset()
}
